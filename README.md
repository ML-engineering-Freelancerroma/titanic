...
После обучения и тестирования моделей на отложенной выборке (`test.csv`) получены следующие метрики:

| Модель     | Accuracy | F1-score | Precision | Recall |
|------------|----------|----------|-----------|--------|
| CatBoost   | 0.8971   | 0.8709   | 0.8011    | 0.9539 |
| XGBoost    | 0.8732   | 0.8285   | 0.8153    | 0.8421 |
| MLP        | 0.8971   | 0.8502   | 0.9037    | 0.8026 |

**Лучшая модель по F1:** CatBoost (0.8709)  
**Лучшая по Accuracy:** CatBoost и MLP (0.8971)

Файлы для сабмита на Kaggle (`submission_*.csv`) сгенерированы для каждой модели.
...
1. **Клонируйте репозиторий:**
   ```bash
   git clone https://github.com/ML-engineering-Freelancerroma/titanic.git
   cd titanic
...
| `catboost`       | Градиентный бустинг (CatBoost)    |
...
**Роман Недосеко**  
GitHub: [@Freelancerroma](https://github.com/Freelancerroma)  
Проект выполнен в рамках изучения машинного обучения.